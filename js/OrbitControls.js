				...
				if ( scope.zoomToCursor && performCursorZoom ) {
					...
					if ( newRadius !== null ) {
						...
						if ( this.screenSpacePanning ) {
							...
							_ray_orbit.origin.copy( scope.object.position );
							_ray_orbit.direction.set( 0, 0, - 1 ).transformDirection( scope.object.matrix );

							// if the camera is 20 degrees above the horizon then don't adjust the focus target to avoid
							// extremely large values
							if ( Math.abs( scope.object.up.dot( _ray_orbit.direction ) ) < TILT_LIMIT ) {
								...
								_ray_orbit.intersectPlane( _plane, scope.target );
